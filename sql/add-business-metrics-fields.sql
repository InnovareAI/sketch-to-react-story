...
ALTER TABLE contacts ADD COLUMN IF NOT EXISTS 
  connection_requested_at TIMESTAMP WITH TIME ZONE,
  ...
  meeting_requested_at TIMESTAMP WITH TIME ZONE,
  meeting_scheduled_at TIMESTAMP WITH TIME ZONE,
  meeting_completed_at TIMESTAMP WITH TIME ZONE,
  sales_stage TEXT DEFAULT 'prospect' CHECK (sales_stage IN ('prospect', 'connected', 'contacted', 'interested', 'meeting_scheduled', 'meeting_completed', 'qualified', 'closed_won', 'closed_lost')),
  interaction_count INTEGER DEFAULT 0,
  last_interaction_at TIMESTAMP WITH TIME ZONE,
  interaction_type TEXT, -- 'message', 'inmail', 'connection_request', 'meeting', etc.
