...
if (!supabaseServiceKey) {
    console.error('❌ SECURITY ERROR: SUPABASE_SERVICE_KEY environment variable is required');
    console.error('   Set it in your .env file: SUPABASE_SERVICE_KEY=your-service-role-key');
    process.exit(1);
}
